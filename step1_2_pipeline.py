...
def analyze_single_profile(vk, profile):
    ...
    if analysis['compatibility_score'] >= 90:
        ...
        msg = f"Привет, {name}. 👋 Мои алгоритмы выделили твой профиль как >90% совместимый с моим весёлым нравом 😄 Если ты открыта к общению, давай знакомиться! В этом посте я написал немного подробне о себе https://vk.com/wall758002654_43 Буду рад ответу!"
    else:
